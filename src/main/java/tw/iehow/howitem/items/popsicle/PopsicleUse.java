...
import static tw.iehow.howitem.items.popsicle.PopsicleDisplay.how_popsicle;
import static tw.iehow.howitem.items.popsicle.PopsicleDisplay.how_popsicle_stick;
...
public class PopsicleUse {
    public static void apply(PlayerEntity player, Hand hand) {
        ...
        player.setStackInHand(hand, how_popsicle_stick());
    ...
    public static void restore(PlayerEntity player, Hand hand) {
        ...
        player.setStackInHand(hand, how_popsicle());
