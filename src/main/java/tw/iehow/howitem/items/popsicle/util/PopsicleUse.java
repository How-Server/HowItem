...
import tw.iehow.howitem.items.popsicle.PopsicleDisplay;
...
public class PopsicleUse {
    public static void apply(PlayerEntity player, Hand hand) {
        ...
        player.setStackInHand(hand, PopsicleDisplay.how_popsicle_stick());
    ...
    public static void restore(PlayerEntity player, Hand hand) {
        ...
        player.setStackInHand(hand, PopsicleDisplay.how_popsicle());
